...
run-w-gdb: add_dylib_debug build_ext
    cd noita-proxy && NP_SKIP_MOD_CHECK=1 cargo run -- --run-noita-with-gdb
...
run2-alt: add_dylib_debug build_ext move_mod
    cd noita-proxy && NP_SKIP_MOD_CHECK=1 cargo run -- --launch-cmd "'E:\Archivos Programas\x64dbg\release\x32' E:/SteamLibrary/steamapps/common/Noita/noita_dev.exe -gamemode 0"

run3: add_dylib_debug build_ext move_mod
    cd noita-proxy && NP_SKIP_MOD_CHECK=1 NP_NOITA_ADDR=127.0.0.1:21253 cargo run -- --launch-cmd "'E:\Archivos Programas\x64dbg\release\x32' E:/SteamLibrary/steamapps/common/Noita/noita_dev.exe -gamemode 0"
